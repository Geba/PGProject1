...
Lá, você poderá alterar entre os modos de Adição/Selecao ou Deleção de pontos. Alem de poder alterar os modos de Ajuste Automatico, e definir os valores de grau da curva e quantidade de avaliações do algoritmo de De Casteljau.
